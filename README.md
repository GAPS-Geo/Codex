...
- გიორგი ჭანტურია - თავმჯდომარე;

- ნიკო გიორგაძე - პროექტორი;

- ელენე მესხი - მწიგნობართუხუცესი;

- მარიამ არუსტაშვილი - ღონის მაძიებელი;

- ქეთევან დანელია - PR;

- ქეთევან არაბული - წევრთუხუცესი;

- დიანა სოხაშვილი - მეჭურჭლეთუხუცესი.

13. გამგეობის როლებია: 
- ა. თავმჯდომარე
- ბ. პროექტორი - მართავს პროექტებს და მათ საორგანიზაციო ჯგუფებს
- გ. ღონის მაძიებელი - მეთვალყურეობს ღონისძიებებს და მათ ორგანიზატორებს
- დ. მწიგნობართუხუცესი - დაკავებულია იურიდიული საკითხებით, დოკუმენტების გამართვით, ახალი წევრების საბუთების ორგანიზებით
- ე. მეჭურჭლეთუხუცესი - განკარგავს ბიუჯეტს და ფინანსებს
- ვ. წევრთუხუცესი - მართავს ასოციაციის წევრებთან კომუნიკაციის და ურთიერთობის საკითხებს
- ზ. PR - დაკავებულია ასოციაციის საქმიანობის შესახებ ინფორმაციის საზოგადოებასთან, პოტენციურ სპონსორებთან და დაინტერესებულ პირებთან მიწოდებით
...
8. ასოციაციის აღმასრულებელი დირექტორი 2021-2023 წლებისთვის არჩეული არ იქნა.
...
## მუხლი 16. მონაცემთა შენახვა და დაცვა
ასოციაციას აქვს უფლება შეაგროვოს ისეთი ინფორმაცია წევრებზე, როგორიცაა მათი იურიდიული მისამართი, პირადი ნომერი, ტელეფონის ნომერი და ა.შ. ეს ინფორმაცია გამოყენებული შეიძლება იქნას ასოციაციის დოკუმენტების შევსებისას და ასოციაციის სხვა ტიპური საქმიანობისას. წევრების პირად ინფორმაციაზე ხელი მიუწვდება მხოლოდ ასოციაციის გამგეობას, რომელსაც თავის მხრივ აქვს უფლება გამოიყენოს ეს მონაცემები მხოლოდ კეთილსინდისიერად, ასოციაციის მიზნებისთვის.

# თავი VI. ასოციაციის რეორგანიზაცია და ლიკვიდაცია

## მუხლი 17. ასოციაციის რეორგანიზაცია
...
## მუხლი 18. ასოციაციის ლიკვიდაცია
